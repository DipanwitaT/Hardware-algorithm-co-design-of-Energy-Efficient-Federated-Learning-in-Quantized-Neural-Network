# -*- coding: utf-8 -*-
"""
Created on Tue Jul  20 14:00:59 2023
...
#import sys; sys.path.append("/../CNN_HAR/Code/utils");
#from utils import *
from utils.Plot.plotInputData import plotData
def readRAWData():
    # path = './Dataset/WISDM_ar_v1.1/WISDM_ar_v1.1_raw.csv'
    path = 'C:/Users/Dipanwita/CNN_HAR/Code/utils/Data/Dataset/WISDM_ar_v1.1/WISDM_ar_v1.1_raw.csv'
    file = open(path)
...
def preprocessData(data):
    ...
    # saving data
    path = 'C:/Users/Dipanwita/Desktop/CNN_HAR/Code/utils/Data/Dataset/WISDM_ar_v1.1/ScaledData.csv'
